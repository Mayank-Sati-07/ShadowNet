...
class ShadowNetFIRPipeline:
    ...
    def process(self, document_path):
        ...
        print("=" * 70)
        print("ShadowNet NLP FIR PIPELINE")
        print("=" * 70)
        ...
        print(
            f"[OK] Extracted {len(text):,} characters"
        )
        ...
        print("[OK] Extraction validation passed")
        ...
        print(
            f"[OK] Persons written: {len(extraction.persons)}"
        )
        ...
        print(
            f"[OK] Locations written: {len(extraction.locations)}"
        )
        ...
        print(
            f"[OK] Events written: {event_count}"
        )
