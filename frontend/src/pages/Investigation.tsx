    ...
    <div className="mx-auto max-w-6xl space-y-8 pb-10">
      ...
      >
        ...
        <button
          ...
          className="mt-4 flex items-center gap-2 rounded-xl bg-[var(--color-primary)] px-6 py-3 text-sm font-medium text-white transition-all duration-300 hover:opacity-90 disabled:opacity-50 disabled:hover:opacity-100 shadow-sm hover:shadow-md"
        >
          {loading ? (
        ...
        >
          <motion.div variants={itemVariants} className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-6 shadow-md">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <span className={`rounded-lg border px-3 py-1.5 text-xs font-medium uppercase tracking-wide ${result.status === "success" ? "border-[var(--color-accent)]/30 bg-[var(--color-accent)]/10 text-[var(--color-accent)]" : "border-[var(--color-destructive)]/30 bg-[var(--color-destructive)]/10 text-[var(--color-destructive)]"}`}>
